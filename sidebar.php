...
if (!isset($menu_visibility[$user_role])) $user_role = 3;
...
function isActivePage($menu_item, $current_page) {
    ...
    if (strpos($current_page, $menu_item . '-list') === 0) return true;
    if ($menu_item === 'dashboard' && $current_page === 'index') return true;
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
        ...
        <li class="nav-item <?php echo $isReportActive ? 'menu-open' : ''; ?>">
          <a href="#" class="nav-link <?php echo $isReportActive ? 'active' : ''; ?>" id="report">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="department-wise-summary" class="nav-link <?php echo $current_page === 'department-wise-summary' ? 'active' : ''; ?>">
                <i class="far fa-circle nav-icon"></i>
                <p>Dept. Wise Summary</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="report-job-wise-status" class="nav-link <?php echo $current_page === 'report-job-wise-status' ? 'active' : ''; ?>">
                <i class="far fa-circle nav-icon"></i>
                <p>Job Wise Status</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="dept-wise-report" class="nav-link <?php echo $current_page === 'dept-wise-report' ? 'active' : ''; ?>">
                <i class="far fa-circle nav-icon"></i>
